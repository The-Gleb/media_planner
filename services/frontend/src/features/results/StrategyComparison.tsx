...
type CurrentRun = { strategy: Strategy; optimize: KPI; facts: CampaignFacts; finished: boolean; execution?: ExecutionMode; historyCount?: number; planSpend?: string | null; planKpi?: string | null }
