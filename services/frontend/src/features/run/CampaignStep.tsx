...
export function CampaignStep(props: Props) {
  ...
  return <div className="stack">
    <section className="card stack control-panel" aria-labelledby="control-title">
      ...
      {activeDraft.simulation.audience && <p className="note">Показы ограничены выбранной в брифе аудиторией в {Object.keys(activeDraft.simulation.audience).length} каналах. Выбор зафиксирован на весь прогон; первоначальный прогноз относится к каналам в целом.</p>}
